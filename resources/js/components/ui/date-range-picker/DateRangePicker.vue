  ...
  <Popover v-model:open="isOpen">
    ...
    <PopoverContent class="w-auto p-0" align="end">
      <div class="flex flex-col sm:flex-row">
        <div class="hidden flex-col border-b border-border py-2 sm:flex sm:w-[170px] sm:shrink-0 sm:border-b-0 sm:border-r">
          <template v-for="(group, groupIndex) in presetGroups" :key="groupIndex">
            <div v-if="groupIndex > 0" class="my-1 border-t border-dashed border-border" />
            <div class="space-y-0.5 px-2">
              <Button
                ...
                variant="ghost"
                size="sm"
                class="h-7 w-full justify-start text-xs font-bold text-foreground hover:bg-accent hover:text-foreground"
